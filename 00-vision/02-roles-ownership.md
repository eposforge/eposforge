...
EposForge instructs adopters to set it up that way. adopter fills that role.
...
- **Adopter Platform Spec** (e.g. adopter repo): the single primary repo as described above.
