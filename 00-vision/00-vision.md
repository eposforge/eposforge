...
Episodic specify runs fold into that Spec; they do not replace it. See the [Living Spec]
component.
...
- **Not opinionated about implementation.** Tool Transport doesn't
  require MCP. Spec Graph doesn't require Neo4j. The [Orchestrator] doesn't require
