...
bash instance/source-control-ci/github-and-actions/scripts/install-hooks.sh --check

# Remove all managed dispatchers
bash instance/source-control-ci/github-and-actions/scripts/install-hooks.sh --uninstall
```
...
must live under `instance/<component>/scripts/`. The same check is
