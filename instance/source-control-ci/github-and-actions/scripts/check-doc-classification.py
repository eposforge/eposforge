...
2. Installed-adapter layout check (--check-layout / CI always) — each entry
   under instance/<component>/<adapter>/ must satisfy:
...
Usage
-----
    python instance/source-control-ci/github-and-actions/scripts/check-doc-classification.py
    python instance/source-control-ci/github-and-actions/scripts/check-doc-classification.py 01-architecture/02-components/
    python instance/source-control-ci/github-and-actions/scripts/check-doc-classification.py instance/SPEC.md 01-architecture/
    python instance/source-control-ci/github-and-actions/scripts/check-doc-classification.py --all
    python instance/source-control-ci/github-and-actions/scripts/check-doc-classification.py --check-layout
"""
...
def check_installed_layout() -> list[str]:
    """Validate instance/<component>/<adapter>/<adapter>.md convention.
...
def main() -> int:
    ...
    if layout_violations:
        ...
        for v in layout_violations:
            print(f"  {v}")
        print()
        print("Convention: instance/<component>/<adapter>/<adapter>.md")
        print("  Scripts go in: instance/<component>/<adapter>/scripts/")
