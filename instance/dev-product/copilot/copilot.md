...
| `status` | `approved` |
> this repo. Per [../../../01-architecture/00-adapter-pattern/adapter-pattern.md](../../../01-architecture/00-adapter-pattern/adapter-pattern.md),
...
| `autonomy_tos_posture` | `subscription-only; supervised-max` (see [../../../01-architecture/03-autonomy-modes/autonomy-modes.md](../../../01-architecture/03-autonomy-modes/autonomy-modes.md)) |
...
in [../../../01-architecture/03-autonomy-modes/autonomy-modes.md](../../../01-architecture/03-autonomy-modes/autonomy-modes.md).
