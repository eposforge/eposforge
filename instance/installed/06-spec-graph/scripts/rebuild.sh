...
# REPO_ROOT here is instance/ — three levels above scripts/
...
if [ "$USE_GRAPHRAG" = true ]; then
  bash "${SCRIPTS_DIR}/../graphrag/scripts/index.sh"
  echo ""
  ...
  "${COGNEE_PYTHON}" "${SCRIPTS_DIR}/../cognee/scripts/cognee_indexing.py"
fi
