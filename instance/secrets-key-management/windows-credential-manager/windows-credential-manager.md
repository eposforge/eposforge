...
This adapter FULFILLS_SLOT `secrets-key-management` for the sandbox execution context.
...
| `bootstrap_script` | [../../execution-sandbox/windows-acl-user/scripts/install-gemini-sandbox.ps1](../../execution-sandbox/windows-acl-user/scripts/install-gemini-sandbox.ps1) |
