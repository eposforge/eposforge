...
| `prompt_control` | GraphRAG: prompt files under `instance/spec-graph/graphrag/prompts/`; Cognee: none (structured extraction built-in) |
...
| `component11_event_emitter` | `instance/inference/scripts/emit-token-usage-event.sh` |
...
| `azure_route_contract` | `instance/inference/azure-foundry-routing.md` |
| `azure_route_validator` | `instance/inference/scripts/validate-azure-routing-config.sh` |
| `budget_policy_file` | `instance/inference/budget-policy.json` |
| `budget_preflight_gate` | `instance/inference/scripts/check-budget-gate.sh` |
| `budget_counter_updater` | `instance/inference/scripts/record-budget-usage.sh` |
| `budget_contract` | `instance/inference/budget-enforcement.md` |
