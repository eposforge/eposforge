...
Usage:
    python instance/tool-transport/mcp-stdio-and-http/scripts/sync-mcp.py
    python instance/tool-transport/mcp-stdio-and-http/scripts/sync-mcp.py --check
...
#   scripts/ -> mcp-stdio-and-http/ -> tool-transport/ -> installed/ -> instance/ -> repo/
# Wait, it's actually:
#   scripts/ -> mcp-stdio-and-http/ -> tool-transport/ -> installed/ -> instance/ -> repo
...
def main() -> int:
    ...
    if check_mode:
        ...
        if drift:
            print(
                "\nRun: python instance/tool-transport/mcp-stdio-and-http/scripts/sync-mcp.py",
                file=sys.stderr,
            )
            return 1
        else:
