...
| 05 Tool Transport | filled | MCP server set | [installed/05-tool-transport/mcp.md](./installed/05-tool-transport/mcp.md) | [../01-architecture/02-components/05-tool-transport.md](../01-architecture/02-components/05-tool-transport.md) |
| 06 Spec Graph | filled | GraphRAG + Neo4j CE | [SPEC.md](./SPEC.md) · [installed/06-spec-graph/](./installed/06-spec-graph/) | [../01-architecture/02-components/06-spec-graph.md](../01-architecture/02-components/06-spec-graph.md) |
| 07 Execution Sandbox | partial | Windows ACL user | [installed/07-execution-sandbox/windows-acl-user.md](./installed/07-execution-sandbox/windows-acl-user.md) | [../01-architecture/02-components/07-execution-sandbox.md](../01-architecture/02-components/07-execution-sandbox.md) |
...
| 09 Source Control / CI | filled | GitHub + GitHub Actions | [installed/09-source-control-ci/github-actions.md](./installed/09-source-control-ci/github-actions.md) | [../01-architecture/02-components/09-source-control-ci.md](../01-architecture/02-components/09-source-control-ci.md) |
...
| 10 Inference | filled | Anthropic + OpenAI | [installed/10-inference/anthropic-openai.md](./installed/10-inference/anthropic-openai.md) | [../01-architecture/02-components/10-inference.md](../01-architecture/02-components/10-inference.md) |
...
| 12 Secrets | filled | env vars + OS credential manager | [installed/12-secrets-key-management/env-and-os-credential-manager.md](./installed/12-secrets-key-management/env-and-os-credential-manager.md) | [../01-architecture/02-components/12-secrets-key-management.md](../01-architecture/02-components/12-secrets-key-management.md) |
