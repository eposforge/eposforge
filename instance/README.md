...
| 06 Spec Graph | filled | Cognee + Neo4j CE (GraphRAG installed fallback) | [SPEC.md](./SPEC.md) · [installed/06-spec-graph/](./installed/06-spec-graph/) | [../01-architecture/02-components/06-spec-graph.md](../01-architecture/02-components/06-spec-graph.md) |
...
| 10 Inference | filled | Anthropic + OpenAI | [installed/10-inference/anthropic-extraction-plus-openai-embeddings/anthropic-extraction-plus-openai-embeddings.md](./installed/10-inference/anthropic-extraction-plus-openai-embeddings/anthropic-extraction-plus-openai-embeddings.md) | [../01-architecture/02-components/10-inference.md](../01-architecture/02-components/10-inference.md) |
