...
| 11 Audit & Observability | filled | JSONL event sink | [installed/11-audit-observability/jsonl-event-sink/jsonl-event-sink.md](./installed/11-audit-observability/jsonl-event-sink/jsonl-event-sink.md) | [../01-architecture/02-components/11-audit-observability.md](../01-architecture/02-components/11-audit-observability.md) |
