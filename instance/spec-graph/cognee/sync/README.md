...
python ..\..\..\secrets-key-management\bin\epos-secrets `
    uv run cognee-sync --modified instance/spec-graph/cognee/cognee.md
...
epos-secrets uv run cognee-sync --ontology-key eposforge \
    --modified instance/spec-graph/cognee/cognee.md
...
Registered in `instance/secrets-key-management/sops-age/secrets.toml`:
