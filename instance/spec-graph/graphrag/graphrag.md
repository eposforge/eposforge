...
| `invocation_surface` | `CLI script (instance/spec-graph/graphrag/scripts/rebuild.sh)` |
...
After a GraphRAG fallback rebuild (`bash instance/spec-graph/graphrag/scripts/rebuild.sh`), confirm
