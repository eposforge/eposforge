...
Constraint: adopter depends on EposForge, never the reverse. This change is entirely internal to EposForge.
...
- adopter-side changes. adopter depends on EposForge; if adopter wants to consume these standards, that change happens in adopter.
