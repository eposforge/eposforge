...
- adopter = adopter platform factory (with adopter- backlog items, private visibility in aggregation).
...
- Terminology: "Adopter Platform Spec (adopter repo)" vs "Platform Instance (concrete LAN)".
