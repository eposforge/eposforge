...
**YOU ARE IN: `eposforge/polecats/quartz/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/eposforge/` (rig root) or other directories
...
**Your mail address:** `eposforge/polecats/quartz`
**Your rig:** eposforge
**Your Witness:** `eposforge/witness`
...
| Ask Witness for help | `gt mail send eposforge/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`eposforge/witness`) when:
...
```bash
gt mail send eposforge/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
