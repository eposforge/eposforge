...
- draft: 2026-07-19
- supersedes: none
- related: [Living Spec], [Source Control + CI],
...
behavior, inputs/outputs, and bounds (see [Source Control + CI]). Requirements:
...
MUST trigger Spec Graph re-projection for the owning scope ([Spec Graph]).
