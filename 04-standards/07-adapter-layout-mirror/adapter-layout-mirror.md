...
adopter is the canonical example of this primary repo. Product repos and other implementation repos remain separate but can be discovered from the primary via workspace files or BACKLOG_ROOTS for a unified portfolio view.
