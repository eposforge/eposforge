...
- related: Component 2 (Living Spec), Component 5 (Tool Transport
  code-structure), Component 6 (Spec Graph), Standard 11 (paired-change)
- spec-version: n/a
...
4. Product registry `code_globs` (Standard 11 / Component 9) MUST point at
...
3. Multi-repo products: index all **code** repos that fulfill the Product;
   keep the Product Living Spec as the single intent HEAD (Component 2).
