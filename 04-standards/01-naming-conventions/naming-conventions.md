...
- Run the sensitive-literals check (or equivalent) and manually confirm no specific adopter repository names appear in public content. Use `rg "the primary adopter|adopter"` (post-scrub this should return nothing in the public tree except possibly in git history).
