...
- All substrate configuration is in source control. No undocumented
  manual changes.
- Secrets are encrypted at rest and resolved through the
  [Secrets & Key Management] Adapter.
- [Audit & Observability] is collecting structured events
  from the substrate.
- Backups are automated and tested for restoration ([Backup / Data Resilience]).
- [Source Control + CI] is operational with signed agent
  attribution.
...
- An [Agent Policy] Adapter is installed with at least
  tier 0–2 support.
...
- The [Orchestrator] is dispatching Platform-scoped sub-tasks
...
- [Release Rings] are formalized: alpha and beta rings
...
[Secrets & Key Management]: ../01-architecture/02-components/secrets-key-management.md
[Audit & Observability]: ../01-architecture/02-components/audit-observability.md
[Backup / Data Resilience]: ../01-architecture/02-components/backup-resilience.md
...
[Release Rings]: ../01-architecture/02-components/release-rings.md
