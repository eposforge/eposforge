...
[Audit & Observability], [Working Memory], and
...
- **Is not:** [Working Memory]. Working Memory is active
  cross-session recall *during* execution and the replacement for
  each Dev Product's native memory store. This slot is the
