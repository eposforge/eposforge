...
> concurrent unlabeled migrations across the roots (the live cost: adopter-042 slates
> Gas Town → Gas City while five open adopter items still invest in the Gas Town shape).
...
> criterion is not currently met (98 errors across 8 roots, 63 in adopter).
