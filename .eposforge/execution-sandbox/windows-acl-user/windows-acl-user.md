...
> [../../../01-architecture/00-adapter-pattern/adapter-pattern.md](../../../01-architecture/00-adapter-pattern/adapter-pattern.md), all
...
| `bound_dev_product` | `gemini-cli` (see [../../dev-product/gemini-cli/gemini-cli.md](../../dev-product/gemini-cli/gemini-cli.md)) |

---

## Setup

Run `.eposforge/execution-sandbox/windows-acl-user/scripts/install-gemini-sandbox.ps1` as administrator. The script is
