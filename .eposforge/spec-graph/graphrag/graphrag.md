...
| `invocation_surface` | `CLI script (.eposforge/spec-graph/graphrag/scripts/rebuild.sh)` |
...
After a GraphRAG fallback rebuild (`bash.eposforge/spec-graph/graphrag/scripts/rebuild.sh`), confirm
