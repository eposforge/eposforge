...
Usage: uv run --with "cognee[fastembed]" --with openai python.eposforge/tool-transport/mcp-stdio-and-http/scripts/cognee-mcp-test.py
...
# ---------------------------------------------------------------------------
async def configure():
    cognee_root = REPO_ROOT / "instance" / "installed" / "spec-graph" / "cognee" / ".cognee"
