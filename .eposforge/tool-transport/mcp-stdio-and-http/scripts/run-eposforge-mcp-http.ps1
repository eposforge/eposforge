...
#   python.eposforge/secrets-key-management/bin/epos-secrets -- pwsh.eposforge/tool-transport/mcp-stdio-and-http/scripts/run-eposforge-mcp-http.ps1
...
$cogneeRoot = (Resolve-Path (Join-Path $PSScriptRoot "..\..\..\spec-graph\cognee\.cognee")).Path
