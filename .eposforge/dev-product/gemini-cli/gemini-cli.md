...
> repo. Per [../../../01-architecture/00-adapter-pattern/adapter-pattern.md](../../../01-architecture/00-adapter-pattern/adapter-pattern.md),
...
| `autonomy_tos_posture` | `subscription-ok-through-supervised; api-key-required-for-autonomous` (see [../../../01-architecture/03-autonomy-modes/autonomy-modes.md](../../../01-architecture/03-autonomy-modes/autonomy-modes.md)) |
...
| `execution_sandbox` | `windows-acl-user` (see [../../../execution-sandbox/windows-acl-user/windows-acl-user.md](../../../execution-sandbox/windows-acl-user/windows-acl-user.md)) |
...
```powershell
runas /user:gemini-runner /savecred "gemini chat --workspace <abs-path-to-eposforge-clone-on-windows>"
```

Setup: run `.eposforge/execution-sandbox/windows-acl-user/scripts/install-gemini-sandbox.ps1` as administrator.
