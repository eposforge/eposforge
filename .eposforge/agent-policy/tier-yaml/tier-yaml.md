...
> Slot contract: [../../../01-architecture/02-components/agent-policy.md](../../../01-architecture/02-components/agent-policy.md)
...
| Field | Value |
|---|---|
| `tier_contract_file` | `.eposforge/agent-policy/tier-yaml/policy.tiers.yaml` |
| `generator_target_default` | `.claude/settings.json` |
| `baseline_expected` | `.eposforge/agent-policy/tier-yaml/baseline/settings.expected.json` |
